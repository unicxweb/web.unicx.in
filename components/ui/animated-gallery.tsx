...
export const GalleryContainer = ({
  ...
  const rotateXDesktop = useTransform(scrollYProgress, [0, 0.5], [75, 0])
  const rotateXMobile = useTransform(scrollYProgress, [0, 0.5], [35, 0])
  const rotateX = isMobile ? rotateXMobile : rotateXDesktop

  const scaleDesktop = useTransform(scrollYProgress, [0.5, 0.9], [1.2, 1])
  const scaleMobile = useTransform(scrollYProgress, [0.5, 0.9], [1.35, 1])
